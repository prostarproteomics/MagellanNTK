...
#' 
#' In this example, `mod_PipelineB_Process1_ui()` and `mod_PipelineB_Process1_server()` define
...
#' @export
#'
mod_PipelineB_Process1_ui <- function(id){
  ns <- NS(id)
}
...
#' @export
#' 
mod_PipelineB_Process1_server <- function(id,
