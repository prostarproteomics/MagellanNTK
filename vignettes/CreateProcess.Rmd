...
papersize: a4
vignette: >
  %\VignetteIndexEntry{Create a new process}
...
The last three parameters are reactive because they are frequently updated during the execution of `Magellan`.
...
# Developer tool to create a new process

A script (``) has been developped to facilitate the developpement of a process. It consists in a shiny app.
