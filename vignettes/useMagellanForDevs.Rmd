...
`Magellan` is intimely linked to the data anaysis modules and vice-versa. 
SO as to facilitate both the developement of a new module and the maintenance,
we have volontary want to have a quite contraint code and Module template. It guarantees xxx
