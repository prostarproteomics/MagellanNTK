---
title: "Inside MagellanNTK (by example)"
...
output: 
    BiocStyle::html_document:
        ...
        papersize: a4
vignette: >
    %\VignetteIndexEntry{Inside MagellanNTK (by example)}
...
The code of `MagellanNTK` has two main objectives:
...
`Magellan` is close linked to the data analysis modules and vice-versa. So 
as to facilitate both the development of a new module and the maintenance, we 
have voluntarily want to have a quite constraint code and Module template. It 
guarantees xxx
...
```{r 'globalArch', results='markup', fig.cap="Global architecture of connectivity between Magellan, 
Shiny and packages containing the code for modules.", echo=FALSE, out.width='100%', 
